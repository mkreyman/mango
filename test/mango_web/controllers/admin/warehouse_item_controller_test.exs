defmodule MangoWeb.Admin.WarehouseItemControllerTest do
  ...
  describe "index" do
    test "lists all warehouse_items", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Warehouse items"
    end
  end
  ...
  describe "create warehouse_item" do
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(
          conn,
          admin_warehouse_item_path(conn, :create),
          warehouse_item: @invalid_attrs
        )
  ...
  describe "edit warehouse_item" do
    ...
    test "renders form for editing chosen warehouse_item", %{
      conn: conn,
  ...
  describe "update warehouse_item" do
    ...
    test "redirects when data is valid", %{conn: conn, warehouse_item: warehouse_item} do
      conn =
        put(
          conn,
          admin_warehouse_item_path(conn, :update, warehouse_item),
          warehouse_item: @update_attrs
        )
